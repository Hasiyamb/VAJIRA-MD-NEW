...
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=eJlkVaKS#fnFCDB3rARyuNQ311jnc2N9FQXwrU6ckcyptJyUYFPc' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '94762664962' : process.env.OWNER_NUMBER,   
